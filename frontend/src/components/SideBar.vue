...
<template>
  <aside
    class="flex h-screen px-6 flex-col items-center border-r border-gray-200 bg-slate-900"
  >
    <div
      class="text-white flex h-[4.5rem] w-full items-center justify-center border-b border-gray-200 p-2"
    >
