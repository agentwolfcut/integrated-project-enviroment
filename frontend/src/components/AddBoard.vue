...
<template>
    ...
    <div class="itbkk-modal-new absolute left-0 right-0 top-1/4 m-auto flex flex-wrap justify-center items-center">
        <div
    ...
    :value="currentUser + ' personal board'">
                ...
                <div class="m-3">
                    <div class="buttons flex gap-2">
                        <button class="itbkk-button-ok disabled border border-slate-800 hover:bg-green-500 hover:text-white transition-all ease-out  p-3 font-medium text-base text-green-800 bg-green-300 rounded-md px-3 disabled:opacity-50 
