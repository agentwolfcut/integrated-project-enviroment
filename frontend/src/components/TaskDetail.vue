      ...
      <div class="bg-white w-7/12 h-auto rounded-2xl shadow-xl">
        ...
        <div class="flex flex-row gap-4 m-4">
          <div class="itbkk-description w-8/12">
            ...
            <div
              v-if="taskSelect.description"
              class="text-base rounded-md py-1 w-6/6 h-12/12"
              type="text"
            >
              {{ taskSelect.description }}
            </div>
            <div v-else class="italic">No Description Provided</div>
          </div>
          <div class="flex flex-col w-5/12">
            <div>
              <div class="itbkk-assignees">
                ...
                <div
                  v-if="taskSelect.assignees"
                  class="text-base rounded-md w-6/6 border p-1"
                >
                  {{ taskSelect.assignees }}
                </div>
                <div v-else class="italic text-slate-600">Unassigned</div>
              </div>
            ...
            <div class="flex flex-col mt-20 gap-1">
              ...
              <div class="itbkk-created-on flex flex-row items-center gap-3">
                ...
                <div class="text-sm rounded-md w-6/6 border px-1">
                  {{ formatLocalDate(taskSelect.createdOn) }}
                </div>
              </div>
              ...
              <div class="itbkk-updated-on flex flex-row items-center gap-3">
                ...
                <div class="text-sm rounded-md w-6/6 border px-1">
                  {{ formatLocalDate(taskSelect.updatedOn) }}
                </div>
              </div>
            </div>
          </div>
