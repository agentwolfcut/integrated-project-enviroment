...
@EnableJpaRepositories(
        basePackages = "dev.backendintegratedproject.userManage",
...
public class DataUserConfig {
    ...
    @Bean
    @ConfigurationProperties(prefix = "spring.login.datasource")
    public DataSourceProperties userAccountDataSourceProperties() {
        return new DataSourceProperties();
    }

    @Bean
    @ConfigurationProperties(prefix = "spring.login.datasource.configuration")
    ...
    public LocalContainerEntityManagerFactoryBean userAccountEntityManagerFactory(
        ...
        return builder
                ...
                .packages("dev.backendintegratedproject.userManage")
                .build();
    }
